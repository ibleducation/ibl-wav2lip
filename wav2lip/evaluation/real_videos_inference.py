...
def main():
	...
	for idx, line in enumerate(tqdm(lines)):
		...
		command = 'ffmpeg -loglevel panic -y -i {} -strict -2 {}'.format(audio_src, '../.wav2lip_temp/temp.wav')
		subprocess.call(command, shell=True)
		temp_audio = '../.wav2lip_temp/temp.wav'
		...
		command = 'ffmpeg -loglevel panic -y -i {} -i {} -strict -2 -q:v 1 {}'.format('../.wav2lip_temp/temp.wav', 
								'../.wav2lip_temp/result.avi', vid)
		subprocess.call(command, shell=True)
